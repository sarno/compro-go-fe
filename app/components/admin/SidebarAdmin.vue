        ...
        <ul class="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap">Hero</span>
            </NuxtLink>
          </li>
          <li>
            <NuxtLink
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap">About Company</span>
            </NuxtLink>
          </li>
          <li>
            <NuxtLink
          ...
          <li>
            ...
            <ul id="dropdown-portofolio" class="hidden py-2 space-y-2">
              <li>
                <NuxtLink
